...
![image-20260622150315079](../../assets/images/ch04/RNN.png)
...
为了缓解标准 RNN 无法保留长距离信息的缺陷，Hochreiter 和 Schmidhuber 于 1997 年提出了长短期记忆网络（Long Short-Term Memory, LSTM），这也是循环神经网络发展史上的一座重要里程碑。![lstm](../../assets/images/ch04/lstm.png)

如图所示，在处理相同的文本序列时，LSTM 在结构上进行了重大改进。最显著的变化在于，它在隐状态 $h_t$（可视为短期记忆）的基础上，引入了一个贯穿整个时间序列的**细胞状态（Cell State, $c_t$）**，充当长期记忆的载体。

详细展示了 LSTM Cell 内部精细的**门控机制（Gated Mechanism）**。LSTM 主要通过以下三个门来保护和控制细胞状态：![lstm-cell](../../assets/images/ch04/lstm-cell.png)
...
![self-vs-cross-attention](../../assets/images/ch04/self-vs-cross-attention.png)
...
![qkv-projection](../../assets/images/ch04/qkv-projection.png)
...
![image-20260623145545258](../../assets/images/ch04/attention.png)
...
![image-20260623145948593](../../assets/images/ch04/QKV.png)
...
![image-20260623150020087](../../assets/images/ch04/attentionQKV.png)
...
![image-20260623150127889](../../assets/images/ch04/multi-head.png)
...
![embedding-plus-pos-encoding](../../assets/images/ch04/embedding-plus-pos-encoding.png)
...
![image-20260623150625525](../../assets/images/ch04/transfomer.png)
...
![encoder-block-structure](../../assets/images/ch04/encoder-block-structure.png)
...
![layernorm-vs-batchnorm](../../assets/images/ch04/layernorm-vs-batchnorm.png)
...
![pre-ln-vs-post-ln](../../assets/images/ch04/pre-ln-vs-post-ln.png)
...
![decoder-block-structure](../../assets/images/ch04/decoder-block-structure.png)
...
![causal-mask](../../assets/images/ch04/causal-mask.png)
...
![mask-combine](../../assets/images/ch04/mask-combine.png)
...
![teacher-forcing-vs-autoregressive](../../assets/images/ch04/teacher-forcing-vs-autoregressive.png)
...
![transformer-family](../../assets/images/ch04/transformer-family.png)
